...
import com.duoc.banco_central_xyz.dto.CuentaBancariaMobileDto;
...
public class CuentaBancariaController {
    ...
    public CuentaBancariaMobileDto obtenerParaMobile(@PathVariable Long id, Authentication authentication) {
        return cuentaBancariaService.obtenerParaMobile(id, authentication.getName());
    }
}