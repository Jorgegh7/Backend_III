...
import cl.duoc.bancoxyz.listener.MovimientoAnualJobListener;
import cl.duoc.bancoxyz.listener.MovimientoAnualSkipListener;
import cl.duoc.bancoxyz.listener.MovimientoAnualStepListener;
...
public class MovimientoAnualBatchConfig {
    ...
    public FlatFileItemReader<MovimientoAnualDto> movimientoAnualItemReader() {
        return new FlatFileItemReaderBuilder<MovimientoAnualDto>()
                ...
                .resource(new ClassPathResource("data/semana_2/cuentas_anuales.csv"))
                .linesToSkip(1)
                .delimited()
    ...
    public Step movimientoAnualStep(JobRepository jobRepository,
        ...
        return new StepBuilder("movimientoAnualStep", jobRepository)
                .<MovimientoAnualDto, MovimientoAnual>chunk(new BancoXyzCompletionPolicy(), movimientoAnualTransactionManager)
                .reader(new SynchronizedItemStreamReader<>(movimientoAnualItemReader))
                .processor(movimientoAnualItemProcessor)
                .writer(movimientoAnualItemWriter)
                .faultTolerant()
                .skipPolicy(new BancoXyzSkipPolicy())
                .taskExecutor(bancoXyzTaskExecutor)
                .listener(new MovimientoAnualStepListener())
                .listener(new MovimientoAnualSkipListener())
                .build();
    }
    ...
    public Job movimientoAnualJob(JobRepository jobRepository, Step movimientoAnualStep) {
        return new JobBuilder("movimientoAnualJob", jobRepository)
                ...
                .listener(new MovimientoAnualJobListener())
